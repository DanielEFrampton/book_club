...
RSpec.describe 'As a user', type: :feature do
  ...
  describe 'When I click the link' do
    it 'I am taken to an Author Show Page with name, title of books, and avg. pages of that author' do
      ...
      expect(page).to have_content("Title: #{@book_1.name}")
      expect(page).to have_content("Title: #{@book_2.name}")
      ...
      expect(page).to have_content("Title: #{@book_3.name}")
      expect(page).to have_content("Title: #{@book_4.name}")
      expect(page).to have_content("Average Number of Pages Per Book: 40")
      ...
      expect(page).to have_content("Title: #{@book_5.name}")
      expect(page).to have_content("Title: #{@book_6.name}")
